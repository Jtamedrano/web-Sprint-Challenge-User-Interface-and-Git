...
> Align-items works on items across the **cross-axis**

5. Explain why git is valuable to a team of developers.
> Git allows for developers to work as a team. It is a space for developers and project managers to track changes, accept changes, and even recover changes/commits. 
